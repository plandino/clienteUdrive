...
public class FileDialog
{
    ...
    public void chooseFile_or_Dir(String dir)
    {
        ...
        {
            Toast.makeText(m_context, "mi file: " + dir + " \npadre: " + dirFile.getParent(), Toast.LENGTH_LONG).show();
                                                             ...
                                                             DialogInterface.OnClickListener onClickListener)
    {
        ...
        m_titleView1.setBackgroundColor(Color.GRAY); // dark gray 	-12303292
        m_titleView1.setTextColor( Color.WHITE);//m_context.getResources().getColor(android.R.color.white) );
        ...
        m_titleView.setBackgroundColor(Color.GRAY); //-12303292); // dark gray -12303292
